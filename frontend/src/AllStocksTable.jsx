              ...
              {sortedStocks.map((stock) => {
                ...
                return (
                  <tr
                    ...
                    className="border-b border-line last:border-0 hover:bg-card-alt transition-colors cursor-pointer"
                  >
                    ...
                    <td className="px-3 py-3.5">
                      {stock.in_watchlist ? (
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.96 }}
                          transition={{ duration: 0.12 }}
                          className="inline-flex items-center gap-1 rounded-lg bg-slate-900 hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed text-white text-[12.5px] font-semibold px-3 py-1.5 transition-colors cursor-pointer whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
                        >
