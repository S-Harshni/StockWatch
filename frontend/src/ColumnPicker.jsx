      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-64 rounded-xl border border-line bg-card shadow-lg p-1.5 z-50"
          >
              ...
              >
                ...
                <label className="flex flex-1 items-center gap-2.5 py-0.5 text-[13px] text-ink-soft hover:text-ink cursor-pointer">
                  <input
                    ...
                    className="h-3.5 w-3.5 rounded border-line text-brand focus:ring-brand/40 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  {col.label}
                </label>
              </div>
